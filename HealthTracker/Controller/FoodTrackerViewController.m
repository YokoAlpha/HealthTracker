...
{
    self.numberOfFoodsEatenTodayLabel.text = [NSString stringWithFormat:@"You had %d %% of your 5 a day",[[HealthTracker sharedHealthTracker]numberOfFoodsEatenForDate:[NSDate date]]];
}
